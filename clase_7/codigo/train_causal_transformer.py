...
ruta = Path("/tmp/data/biblia/biblia.txt")
ruta.parent.mkdir(parents=True, exist_ok=True)
urlretrieve(
    "https://huggingface.co/datasets/puruchinera/biblia_esp.txt/resolve/main/biblia.txt",
    ruta,
)
...
output_dir = directorio_script / "resultados" / "causal_transformer"
output_dir.mkdir(parents=True, exist_ok=True)
prompt_generacion = "En el principio"
